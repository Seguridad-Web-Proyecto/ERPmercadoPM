...
public class CategoriaFacadeREST extends AbstractFacade<Categoria> {
    ...
    public Categoria find(@PathParam("id") Long id) {
        ...
        Categoria categoria = APIConsumerMercado.obtenerCategoriaXId(id);
        return categoria;
    }
    ...
    public List<Categoria> findAll() {
        ...
        List<Categoria> categorias = APIConsumerMercado.categorias("");
        return categorias;
    }
    ...
    public List<Categoria> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
        List<Categoria> categorias = APIConsumerMercado.categorias("/"+from.toString()+"/"+to.toString());
        return categorias;
    }
    ...
    public String countREST() {
        return APIConsumerMercado.categoriasCOUNT();
    }
